                                ...
                                @if(isset($data['rows']) && count($data['rows'])>0)
                                    @foreach($data['rows'] as $key => $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ asset(str_replace('public','storage',$row->file)) }}" download><i class="fa fa-download"></i> Download</a>
                                            </td>
                                            <td>
...
{{--                                                   href="{{ route($base_route.'show',$row->id) }}"><i--}}
{{--                                                        class="fa fa-edit"></i> Add Images</a>--}}
</div>
                                            </td>
                                        </tr>
                                    @endforeach
