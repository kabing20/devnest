...
<div class="form-group row">
    ...
    <div class="col-md-8">
        ...
        @endif
        <input type="file" name="best_choice_image" id = "images" class="{{ ($errors->has('best_choice_image'))?' form-error':'' }}" multiple="multiple">
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        ...
        @if(isset($row->video_banner_thumb))
            ...
            <div class="form-group">
                <img src="{{$row->VideoBannerThumb('50_50')}}" style="width: 120px;" alt="">

            </div>
        @endif
        <input type="file" name="video_banner_thumb" id = "image" class="{{ ($errors->has('video_banner_thumb'))?' form-error':'' }}" multiple="multiple">
...
<div class="form-group row">
    ...
    <div class="col-md-8">
        <label> Url : (https://www.youtube.com/watch?v=demo)</label>
        @if(isset($row->video_banner_url))
            <div class="form-group">
                <img src="{{ $row->video_banner_url }}" style="width: 120px;" alt="">
            </div>
        @endif
        <input type="text" name="video_banner_url" placeholder="https://www.youtube.com/watch?v=demo" value="{{ old('video_banner_url') ?? $row->video_banner_url ?? '' }}"
               class="form-control{{ ($errors->has('best_choice_title'))?' form-error':'' }}">
